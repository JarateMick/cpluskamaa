...
REM platform exe
I:\Dev\LLVM\msbuild-bin\cl %CFLAGS% /MD /I..\libs\gl3w %ADDITIONAL% ..\src\main.cpp   %LIBS%  /link %LFLAGS% opengl32.lib /LIBPATH:"../deps/lib" /SUBSYSTEM:CONSOLE
...
REM Imgui tools.dll 
I:\Dev\LLVM\msbuild-bin\cl %CFLAGS% -DDLLCOMPILE=1 %ADDITIONAL% ..\src\imguiTools.cpp /MD  -LD %LIBS% /link -incremental:no -PDB:imguiTools_%random%.pdb /LIBPATH:"../deps/lib" -EXPORT:Imgui
