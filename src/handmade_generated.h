...
member_definition membersOf_game_state[] = 
{
	...
	{0, MetaType_BulletBody, "bulletBodies", (u32)&((game_state *)0)->bulletBodies }, 
	//{0, MetaType_BulletBody, "maxiumBullets", (u32)&((game_state *)0)->maxiumBullets }, 
	{0, MetaType_BulletStart, "bulletStart", (u32)&((game_state *)0)->bulletStart }, 
	//{0, MetaType_BulletStart, "maxiumBullets", (u32)&((game_state *)0)->maxiumBullets }, 
	{0, MetaType_vec2f, "BulletAccelerations", (u32)&((game_state *)0)->BulletAccelerations }, 
	//{0, MetaType_vec2f, "maxiumBullets", (u32)&((game_state *)0)->maxiumBullets }, 
	{0, MetaType_int, "bulletCount", (u32)&((game_state *)0)->bulletCount }, 
